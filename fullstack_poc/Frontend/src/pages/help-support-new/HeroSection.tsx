...
const HeroSection = ({ setTopic }: HeroSectionProps) => {
        ...
        <>
            <div className="grid grid-cols-12 gap-4 justify-between items-center">
                <div className="col-span-12 lg:col-span-5 lg:mb-0 mb-15">
                    <Heading priority="1">
                        <span className="text-[#AEAEAE] font-bold lg:text-[48px] text-3xl">How can we help?</span>
                    </Heading>
                    <Text size="md" customClass="text-primary lg:mb-0 mb-8">Let our health nerds be your solution today</Text>
                    ...
                    >
                        ...
                        {(searchDropdown &&
                            searchData &&
                            (searchData as any).allFaqs.data.length > 0 && (
                                <div className="rounded-lg bg-white p-2 shadow-lg relative z-11">
                ...
                <div className="col-span-12 lg:col-span-6 lg:order-last order-first">
                    <CustomImage src={HeroImg} alt="Description of image" width={580} height={451} />
                </div>
            </div>
        </>
    );
