...
import PostYourQuery from '@/pages/help-support/postYourQuery';
...
const AllFaqs = ({ setTopic }: AllFaqsProps) => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      shortAnswer:
        "To update your profile information, navigate to your account settings by clicking on your profile picture and selecting 'Settings'. In the profile section, you can edit your display name, bio, profile picture...",
    },
    {
      id: 6,
      question: 'How do I manage my notification preferences?',
      answer:
        "To manage your notification preferences, go to Settings and select 'Notifications'. Here you can customize which types of notifications you want to receive via email, push notifications, or in-app notifications. You can control notifications for new posts, comments, likes, follows, messages, and system updates. Toggle each notification type on or off according to your preferences. You can also set quiet hours during which you won't receive notifications, and choose the frequency of email digests.",
      shortAnswer:
        "To manage your notification preferences, go to Settings and select 'Notifications'. Here you can customize which types of notifications you want to receive via email, push notifications...",
    },
    {
      id: 7,
      question: 'How can I report inappropriate content?',
      answer:
        "To report inappropriate content, click on the three dots menu next to the post or comment and select 'Report'. Choose the reason for reporting from the available options such as spam, harassment, inappropriate content, or copyright violation. Provide additional details if necessary to help our moderation team understand the issue. All reports are reviewed by our content moderation team within 24-48 hours. You can also block users to prevent them from interacting with your content.",
      shortAnswer:
        "To report inappropriate content, click on the three dots menu next to the post or comment and select 'Report'. Choose the reason for reporting from the available options...",
    },
    {
      id: 8,
      question: 'How do I enable two-factor authentication?',
      answer:
        "To enable two-factor authentication (2FA), go to Account Settings and select 'Security'. Click on 'Enable Two-Factor Authentication' and choose your preferred method: SMS or authenticator app. If using SMS, enter your phone number and verify it with the code sent. If using an authenticator app, scan the QR code with apps like Google Authenticator or Authy. Once set up, you'll need to enter a verification code along with your password when logging in. Keep your backup codes in a safe place for account recovery.",
      shortAnswer:
        "To enable two-factor authentication (2FA), go to Account Settings and select 'Security'. Click on 'Enable Two-Factor Authentication' and choose your preferred method: SMS or authenticator app...",
    },
    {
      id: 9,
      question: 'How can I download my data?',
      answer:
        "To download your data, go to Account Settings and select 'Privacy & Data'. Click on 'Download My Data' and choose what information you want to include in your download such as posts, comments, messages, and profile information. The data will be prepared in a downloadable format (usually ZIP file) and you'll receive an email notification when it's ready. The download link will be valid for 7 days. This feature helps you keep a backup of your data or transfer it to another platform if needed.",
      shortAnswer:
        "To download your data, go to Account Settings and select 'Privacy & Data'. Click on 'Download My Data' and choose what information you want to include in your download...",
    },
  ];
