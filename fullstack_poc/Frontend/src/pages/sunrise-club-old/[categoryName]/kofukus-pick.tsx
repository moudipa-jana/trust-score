...
import LottieLoader from '@/components/Utility/LogoLoader/LottieLoader';
...
import KofukuPicks from './KofukuPicks.json' assert { type: 'json' };
...
function KofukuPick({
  ...
  useEffect(() => {
    if (!ismobile) {
      ...
      const timeout = setTimeout(() => {
        ...
        // Set loader completion state to true
  ...
  return (
    <PageBase
      title="Kofuku's Pick"
      description="Kofuku's Pick"
      initialMenus={initialMenus}
      initialBottomMenus={initialBottomMenus}
      searchData={searchData}
      initialSocials={initialSocials}
    >
      <div className="k-picks animate-flickerHide opacity-0 ">
        <div id="contentOuter" className="mt-0">
          {!ismobile && (
            <div className="banner-lottie xl:h-calc" id="bannerImage">
              {animationReady ? (
                <LottieLoader
                  animationData={KofukuPicks}
                  loop={loop}
                  play={play}
          ...
          <div className="lg:-mt-8 xl:mt-14">
            <div
            ...
            <div className="block py-5 text-center lg:hidden lg:text-start">
              <span className="weirdShapeTitle">Kofuku&apos;s pick</span>
            </div>
